...
const englishLabels = {
  ...
  deleteUncertain: "Delete uncertain",
  discard: "Discard",
...
const chineseLabels: Labels = {
  ...
  saveSettings: "保存设置",
  saveTitle: "保存标题",
  saveViewOnce: "保存阅后即焚设置",
  selectedRevision: "已选修订版本",
  setPassword: "设置密码",
  unifiedDiff: "统一差异",
  useRemote: "使用远程内容",
};
...
const englishValidation = {
  contentInvalidScalar: "Content contains an invalid Unicode scalar value.",
  contentRequired: "Content is required.",
  contentTooLarge: "Content exceeds the 10 MiB limit.",
  customIdInvalid: "Custom ID must use the allowed characters.",
  deleteDescription: "Delete this paste permanently.",
  passwordInvalid: "Password must use 1 to 128 visible ASCII characters.",
  titleInvalidScalar: "Title contains an invalid Unicode scalar value.",
...
const chineseValidation: ValidationMessages = {
  contentInvalidScalar: "内容包含无效的 Unicode 标量值。",
  contentRequired: "需要输入内容。",
  contentTooLarge: "内容超过 10 MiB 限制。",
  customIdInvalid: "自定义 ID 包含不允许的字符。",
  deleteDescription: "永久删除此剪贴板。",
  passwordInvalid: "密码必须使用 1 到 128 个可见 ASCII 字符。",
  titleInvalidScalar: "标题包含无效的 Unicode 标量值。",
  titleTooLong: "标题过长。",
};
